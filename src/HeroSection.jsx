    ...
    return (
        <div className="bg-[#00413D] w-full bg-shape bg-left bg-no-repeat">
            <div className="flex flex-col md:flex-row items-center md:justify-end relative">
                <div
                    className="md:z-10 text-white p-5 font-velkorn md:absolute md:translate-x-[26%] md:translate-y-1/2 top-10 -left-16">
                    <span className="md:text-8xl text-3xl font-bold">I’m Maisa Monoara <br /> Moule</span>
                    <p className="text-[rgba(255,255,255,0.51)] font-jost md:w-2/3">I’am freelance <span
                            className="text-white">UI/UX Designer</span> based in Indonesia who loves to craft attractive
